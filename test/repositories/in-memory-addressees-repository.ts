import { Addressee } from 'src/domain/administration/entities/addressee';
import { AddresseesRepository } from 'src/domain/administration/repositories/addressees-repository';
