...
import { DeliveriesWithAddressee } from '@/domain/deliveries/repositories/deliveries-repository';
import { Addressee, Order } from '@prisma/client';

export class PrismaDeliveryWithAddresseeMapper {
  static toDomain(delivery: Order & Addressee): DeliveriesWithAddressee {
    return {
      id: delivery.id,
